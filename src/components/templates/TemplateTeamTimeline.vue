...
<template>
  <div class="preview-container">
    <div class="resume-page" :style="{ '--primary-color': theme.primaryColor, '--secondary-color': theme.secondaryColor, '--accent-color': theme.accentColor }">
      <!-- Header -->
      <header class="resume-header timeline">
      ...
      <!-- Experience -->
      <section v-if="resumeData.experience.length" class="section timeline">
      ...
      <!-- Projects -->
      <section v-if="resumeData.projects.length" class="section timeline">
      ...
      <!-- Education -->
      <section v-if="resumeData.education.length" class="section timeline">
      ...
      <!-- Skills -->
      <section v-if="resumeData.skills.length" class="section timeline">
      ...
      <!-- Awards -->
      <section v-if="resumeData.awards.length" class="section timeline">
