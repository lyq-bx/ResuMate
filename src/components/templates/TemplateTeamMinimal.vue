...
<template>
  <div class="preview-container">
    <div class="resume-page" :style="{ '--primary-color': theme.primaryColor, '--secondary-color': theme.secondaryColor, '--accent-color': theme.accentColor }">
      ...
      <!-- Experience -->
      <section v-if="resumeData.experience.length" class="section minimal">
      ...
      <!-- Projects -->
      <section v-if="resumeData.projects.length" class="section minimal">
      ...
      <!-- Education -->
      <section v-if="resumeData.education.length" class="section minimal">
      ...
      <!-- Skills -->
      <section v-if="resumeData.skills.length" class="section minimal">
      ...
      <!-- Awards -->
      <section v-if="resumeData.awards.length" class="section minimal">
...
.resume-header.minimal .avatar-wrapper.center {
  display: flex;
  justify-content: center;
  margin-bottom: 10px;
}

.resume-header.minimal .header-row {
  display: flex;
  justify-content: space-between;
  align-items: flex-start;
}

.resume-header.minimal .personal-info {
  text-align: left;
}

.resume-header.minimal .contact-info {
  text-align: right;
}
